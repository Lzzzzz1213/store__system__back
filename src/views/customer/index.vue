...
import { createUserDataApi, UserDisableOrEnable } from "@/api/user"
...
//#endregion
function customerDisableOrEnable(user_id: any) {
          ...
          <el-table-column prop="status" label="状态" align="center">
            <template #default="scope">
              <el-tag
                ...
                type="success"
                effect="plain"
                @click="customerDisableOrEnable(scope.row.id)"
                >启用</el-tag
              >
              <el-tag v-else type="danger" effect="plain" @click="customerDisableOrEnable(scope.row.id)">禁用</el-tag>
            </template>
          </el-table-column>
